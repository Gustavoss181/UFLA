...
void criarMatrizProjecao(Ponto4D teste, Ponto4D origem, Ponto4D direcaoX, Ponto4D direcaoY, Ponto4D centroDireProj){
    // Ponto4D dirX_normalizado = normalizar(direcaoX);
    // Ponto4D dirY_normalizado = normalizar(direcaoY);

    Matriz4x4 MtzTrans;
    MtzTrans.fazerTranslacao(origem);
    cout << "Matriz Transformacao" << endl;
    MtzTrans.mostrar();
    cout << "-----------------------" << endl;

    Matriz4x4 MtzRot1;
    MtzRot1.fazerRotacaoY(direcaoX);
    cout << "Matriz Rotacao Y" << endl;
    MtzRot1.mostrar();
    cout << "-----------------------" << endl;

    Matriz4x4 mtz1 = MtzRot1 * MtzTrans;
    mtz1.mostrar();
    cout << "---------------------" << endl;
    ...
    cout << "Matriz Rotacao Z" << endl;
    MtzRot2.mostrar();
    cout << "-----------------------" << endl;
    
    Matriz4x4 mtz2 = MtzRot2*MtzRot1*MtzTrans;
    mtz2.mostrar();
    cout << "-----------------------" << endl;
    ...
    if(centroDireProj.w == 0){
        ...
        cout << "Matriz de Cisalhamento" << endl;
        MtzCisa.mostrar();
        cout << "-----------------------" << endl;
        ...
        centroDireProj_alterado.mostrar();
        cout << "Matriz de Translacao do Centro pra Origem" << endl;
        MtzTransCentro.mostrar();
        cout << "-----------------------" << endl;

        Ponto4D origem_alterado = MtzAux * origem;
        origem_alterado = MtzTransCentro * origem_alterado;
        origem_alterado.mostrar();
    ...
    Ponto4D teste2 = MtzResult*teste;
    teste2.mostrar();
}
...
int main(){
    ...
    cout << acharAngulo(direcaoX, direcaoY)*180/M_PI << endl;
