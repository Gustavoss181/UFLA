...
public class CaixaEletronicoComHashMap {
    ...
    private boolean menu(){
        ...
        switch(opcao){
            ...
            case 9:
                conta = buscarConta();
                if(conta != null)
                    removerConta(conta.getNumConta());
                else
                    System.out.println("Conta nao criada");
                break;
            case 10:
    ...
    private void criarConta(){
        ...
        contas.put(novaConta.getNumConta(), novaConta);
    ...
    private void listarTodasAsContas(){
        for(int numConta : contas.keySet())
            System.out.println(numConta + " - " + contas.get(numConta).getNomeTitular());
    }
    ...
    private void buscarContasNome(){
        ...
        for(int numConta : contas.keySet())
            if(contas.get(numConta).getNomeTitular().contains(subStr))
                System.out.println(contas.get(numConta).getNumConta() + " - " + contas.get(numConta).getNomeTitular());
    }
}
